...
{
    // Published output of the Backend project, produced by scripts/deploy-api.ps1. Every function
        ...
        EnvironmentConfig config, string name, HttpMethod method, string path, string functionClass)
    {
        var function = new Function(this, $"{name}Function", new FunctionProps
        {
            ...
            Handler = $"Backend::Backend.Functions.{functionClass}_Handle_Generated::Handle",
